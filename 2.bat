...
if exist "League of Legends.exe" (
	@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator kr3.spectator.op.gg:80 UStX/mf0hTevcT3SbinAnzR93+8lHSRB 3292766286 KR-%RANDOM%%RANDOM%" "-UseRads"
	goto :eof
)
:cannotFind
echo ===================
